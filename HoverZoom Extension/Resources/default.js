...
hoverZoomPlugins.push({
    ...
    prepareImgLinks: function (callback) {
        ...
        $('img[src]').filter(function () {
            ...
            if (this.naturalWidth && this.naturalWidth < 50)
                return false;
            if (this.naturalHeight && this.naturalHeight < 50)
                return false;
            return true;
        }).each(function () {
            const _this = $(this), data = _this.data();
            ...
            if (!fullSrc) {
                fullSrc = this.getAttribute('data-src') ||
            ...
            if (fullSrc && fullSrc !== this.src) {
                ...
                if (this.naturalWidth > displayedWidth * 1.2 || this.naturalHeight > displayedHeight * 1.2) {
