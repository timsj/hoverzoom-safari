  ...
  prepareImgLinks: function (callback) {
    ...
    $("[style]").each(function () {
      ...
      if (
        ...
        backgroundImage.indexOf("imgur") !== -1
      ) {
    ...
    hoverZoom.urlReplace(res, 'img[src*="imgur"]', "_d.", ".");

    hoverZoom.urlReplace(res, 'img[src*="imgur"]', /\?s=.*/, "");
    ...
    $('a[href*="/gallery/"]')
      .filter(function () {
        return /imgur\.com\/gallery/.test($(this).prop("href"));
      })
      .one("mouseover", function () {
        const link = $(this);
