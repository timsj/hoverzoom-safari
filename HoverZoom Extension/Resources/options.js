...
async function loadOptionsUI() {
  try {
    ...
    // General
    document.getElementById("extensionEnabled").checked = options.extensionEnabled !== false;
    document.getElementById("showHighRes").checked = options.showHighRes !== false;
    document.getElementById("zoomVideos").checked = options.zoomVideos !== false;
    ...
    document.getElementById("picturesOpacity").value = options.picturesOpacity || 1;
    ...
    document.getElementById("showDetailFilename").checked = options.showDetailFilename !== false;
    document.getElementById("showDetailHost").checked = options.showDetailHost !== false;
    document.getElementById("showDetailDimensions").checked =
      options.showDetailDimensions !== false;
    document.getElementById("showDetailScale").checked = options.showDetailScale !== false;
    document.getElementById("showDetailRatio").checked = options.showDetailRatio !== false;
    document.getElementById("showDetailExtension").checked = options.showDetailExtension !== false;
    ...
    document.getElementById("showDetailDuration").checked = options.showDetailDuration !== false;
    ...
    document.getElementById("enableGalleries").checked = options.enableGalleries !== false;
    document.getElementById("galleriesMouseWheel").checked = options.galleriesMouseWheel !== false;
    document.getElementById("mouseUnderlap").checked = options.mouseUnderlap !== false;

    // Excluded Sites
    document.getElementById("whiteListMode").checked = options.whiteListMode === true;
    document.getElementById("excludedSites").value = (options.excludedSites || []).join("\n");
...
async function saveOptions() {
  try {
    ...
    const options = {
      ...
      // Display
      displayDelay: parseInt(document.getElementById("displayDelay").value) || 100,
      fadeDuration: parseInt(document.getElementById("fadeDuration").value) || 200,
      ...
      showDetailDimensions: document.getElementById("showDetailDimensions").checked,
      ...
      showDetailExtension: document.getElementById("showDetailExtension").checked,
      showDetailContentLength: document.getElementById("showDetailContentLength").checked,
      showDetailLastModified: document.getElementById("showDetailLastModified").checked,
      ...
      galleriesMouseWheel: document.getElementById("galleriesMouseWheel").checked,
