...
hoverZoomPlugins.push({
  ...
  prepareImgLinks: function (callback) {
    ...
    function fetchPhoto(link, attr) {
      ...
      let regexGraphId =
        /\/graph\.facebook\.com\/.*\/(\d+)\//; //sample: https://graph.facebook.com/v2.9/1125844704094568/picture?type=square&height=64&width=64
      ...
      if (storedUrl == null) {
        let requestUrl =
          "https://graph.facebook.com/" + graphId + "/picture?type=large&width=9999";
