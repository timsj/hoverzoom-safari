      ...
      browser.runtime.sendMessage(
        ...
        function (response) {
          ...
          try {
            ...
            let widths = j["streamingData"]["adaptiveFormats"]
            ...
            let bitrates = j["streamingData"]["adaptiveFormats"]
              .filter((f) => f.mimeType.indexOf("audio/mp4") !== -1)
              .map((f) => f.bitrate);
            let bitrateMax = Math.max(...bitrates);
            let bestAudio = j["streamingData"]["adaptiveFormats"]
              .filter((f) => f.mimeType.indexOf("audio/mp4") !== -1)
              .find((f) => f.bitrate === bitrateMax);
